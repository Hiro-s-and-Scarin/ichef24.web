export const recipeTags = {
  protein: ["Frango", "Carne", "Peixe", "Porco", "Cordeiro", "Vegano", "Vegetariano"],
  cuisine: ["Italiano", "Brasileiro", "Japonês", "Chinês", "Mexicano", "Indiano", "Francês", "Mediterrâneo"],
  dishType: ["Sopa", "Salada", "Pasta", "Risotto", "Sobremesa", "Bebida", "Aperitivo", "Prato Principal"],
  difficulty: ["Fácil", "Médio", "Difícil"],
  prepTime: ["Rápido (< 30 min)", "Médio (30-60 min)", "Longo (> 60 min)"],
  occasion: ["Café da manhã", "Almoço", "Jantar", "Lanche", "Festa", "Romântico", "Familiar"]
}
