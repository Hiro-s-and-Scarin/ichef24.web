...
const resources = {
  ...
  en: {
    translation: {
      ...
      "ai.error.message":
        "Desculpe, ocorreu um erro ao gerar a receita. Por favor, tente novamente.",
      ...
      "ai.improve.suggestion":
        'Ótima ideia! Vou ajudar você a melhorar a receita "{title}". Aqui estão minhas sugestões!',
      ...
      "recipe.rating.thank.you":
        "Obrigado pela sua avaliação de {rating} {stars}!",
