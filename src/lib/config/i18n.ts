...
const resources = {
  pt: {
    translation: {
      ...
      "community.post.login.required": "Faça login para curtir posts",
      "community.post.already.liked": "Você já curtiu este post",
      "community.post.like.error": "Erro ao curtir post",
      "community.post.copy.link": "Copiar link",
      "community.post.link.copied": "Link copiado com sucesso!",
      ...
      // Recipe Details Page
      "recipe.details.loading": "Carregando receita...",
      "recipe.details.error": "Erro ao carregar receita",
      "recipe.details.not.found": "Receita não encontrada",
      "recipe.details.minutes": "minutos",
      ...
      "recipe.details.already.liked": "Você já curtiu esta receita",
      "recipe.details.liked.success": "Receita curtida com sucesso!",
      "common.you": "Você",
      "common.error": "Erro",
  ...
  en: {
    translation: {
      ...
      "community.topChefs.recipes.count.short": "recipes",
      "community.topChefs.likes.count.short": "likes",
      "community.topChefs.recipes.count": "Recipes",
      "community.topChefs.total.likes": "Likes",
      "community.topChefs.rank.1": "🥇 1st Place",
      ...
      "community.top.recipes.rank.3": "🥉 3rd Best",
      "community.top.recipes.performance": "Performance:",
      "community.top.recipes.viral": "Viral",
      "community.top.chefs.rank.number": "#{number} Top Chef",
      "community.trending.title": "Featured Recipes",
      ...
      "community.post.views": "views",
      "community.post.comments": "comments",
      "community.post.shares": "shares",
      ...
      // Recipe Details Page
      "recipe.details.loading": "Loading recipe...",
      "recipe.details.error": "Error loading recipe",
      "recipe.details.not.found": "Recipe not found",
      "recipe.details.minutes": "minutes",
      "recipe.details.servings": "servings",
      "recipe.details.favorites": "Favorites",
      "recipe.details.ingredients": "Ingredients",
      "recipe.details.ingredients.not.available": "Ingredients not available",
      ...
      "recipe.details.save.recipe": "Save Recipe",
      "recipe.details.share.copied": "Recipe link copied to clipboard!",
      "recipe.details.share.error": "Error copying link",
      "recipe.details.difficulty.easy": "Easy",
      ...
      "recipe.details.save.error": "Error saving recipe",
      "recipe.details.process.error": "Error processing message",
      "recipe.details.not.found.error": "Recipe not found",
      "recipe.details.already.liked": "You already liked this recipe",
      "recipe.details.liked.success": "Recipe liked successfully!",
      "common.you": "You",
      "common.error": "Error",
