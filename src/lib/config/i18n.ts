...
const resources = {
  pt: {
    ...
    "form.recipe.image": "Imagem da Receita",
    "form.file.selected": "Arquivo selecionado",
          "form.image.url.alternative": "Ou insira uma URL da imagem:",
      "form.ingredient.name": "Nome do ingrediente",
      "form.ingredient.amount": "Quantidade",
      "form.step.description": "Descreva este passo...",
