    ...
    <Card className="w-full max-w-2xl">
      ...
      <CardContent className="space-y-4">
        ...
        <div>
          ...
          <p>
            Backend: {mockBackendData.difficulty_level} → Traduzido:{" "}
            {translate.difficulty(mockBackendData.difficulty_level)}
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            Backend: {mockBackendData.cuisine_type} → Traduzido:{" "}
            {translate.cuisine(mockBackendData.cuisine_type)}
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            Backend: {mockBackendData.status} → Traduzido:{" "}
            {translate.recipeStatus(mockBackendData.status)}
          </p>
        </div>
          ...
          <ul className="space-y-1">
            {mockBackendData.ingredients.map((ingredient, index) => (
              <li key={index}>
                ...
                {translate.unit(ingredient.unit)}
              </li>
            ))}
          </ul>
        </div>
