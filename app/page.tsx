...
import { ChefHat, Send, Save, Loader2, X, Clock, Users, LogIn, UserPlus } from "lucide-react"
...
function HomePageContent() {
  ...
  const handleInputSubmit = async (e: React.FormEvent) => {
    ...
    if (!user) {
      setDashboardState(prev => ({ ...prev, showLoginModal: true }))
      return
    }
  ...
  const handleCloseLoginModal = () => {
    setDashboardState(prev => ({ ...prev, showLoginModal: false }))
  }
